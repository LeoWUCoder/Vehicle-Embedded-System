 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: Com_Cfg.h
 *   Generation Time: 2026-04-03 19:56:38
...
#define Com_GetTxPduInfoIdxOfTxSigInfo(Index)                         ((Com_TxPduInfoIdxOfTxSigInfoType)((((Com_TxPduInfoIdxOfTxSigInfoType)(Index)) + 1u)))  /**< the index of the 1:1 relation pointing to Com_TxPduInfo */
/** 
  \}
*/ 
