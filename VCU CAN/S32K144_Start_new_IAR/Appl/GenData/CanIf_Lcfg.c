 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: CanIf_Lcfg.c
 *   Generation Time: 2026-04-03 19:56:39
...
CONST(CanIf_TxBufferPrioByCanIdByteQueueMappedTxPdusType, CANIF_CONST) CanIf_TxBufferPrioByCanIdByteQueueMappedTxPdus[4] = {
  ...
  { /*     3 */            3uL  /* /ActiveEcuC/CanIf/CanIfInitCfg/VCU_CanIf_CANtrv */                              }   /* [/ActiveEcuC/CanIf/CanIfInitCfg/CHNL_0fb271d2] */
};
#define CANIF_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
...
CONST(CanIf_TxPduConfigType, CANIF_CONST) CanIf_TxPduConfig[4] = {
  ...
  { /*     3 */ 0x0010u, PduRConf_PduRDestPdu_PduRDestPdu                      ,           0uL  /* /ActiveEcuC/CanIf/CanIfCtrlDrvCfg_7d254554/CT_CAN00_9df8a959 */,  8u,              0uL  /* /ActiveEcuC/Can/CanConfigSet/CN_CAN00_5e566ad9_Tx */,                      2uL  /* PduR_CanIfTxConfirmation */ }   /* [PDU: VCU_CanIf_CANtrv]                              */  /* [/ActiveEcuC/CanIf/CanIfInitCfg/VCU_CanIf_CANtrv] */
};
#define CANIF_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
...
CONST(CanIf_TxPduQueueIndexType, CANIF_CONST) CanIf_TxPduQueueIndex[4] = {
  ...
  { /*     3 */        3uL  /* /ActiveEcuC/CanIf/CanIfInitCfg/VCU_CanIf_CANtrv */                              }   /* [VCU_CanIf_CANtrv, BasicCAN TxPdu with Tx-buffer]                              */  /* [/ActiveEcuC/CanIf/CanIfInitCfg/VCU_CanIf_CANtrv, /ActiveEcuC/CanIf/CanIfCtrlDrvCfg_7d254554/CT_CAN00_9df8a959] */
};
#define CANIF_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
...
VAR(CanIf_TxQueueUType, CANIF_VAR_NOINIT) CanIf_TxQueue;  /* PRQA S 0759 */  /* MD_CSL_18.4 */
  ...
  /*     3 */  /* [/ActiveEcuC/CanIf/CanIfInitCfg/VCU_CanIf_CANtrv] */
