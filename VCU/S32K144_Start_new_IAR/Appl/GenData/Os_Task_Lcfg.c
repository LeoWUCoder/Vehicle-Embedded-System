...
/*! Dynamic task data: myTask_1000ms */
OS_LOCAL VAR(Os_TaskType, OS_VAR_NOINIT) OsCfg_Task_myTask_1000ms_Dyn;

/*! Dynamic task data: myTask_100ms */
OS_LOCAL VAR(Os_TaskType, OS_VAR_NOINIT) OsCfg_Task_myTask_100ms_Dyn;

/*! Dynamic task data: myTask_20ms */
OS_LOCAL VAR(Os_TaskType, OS_VAR_NOINIT) OsCfg_Task_myTask_20ms_Dyn;
...
/*! Task configuration data: myTask_1000ms */
CONST(Os_TaskConfigType, OS_CONST) OsCfg_Task_myTask_1000ms =
{
  /* .Thread                = */
  {
    /* .ContextConfig         = */ &OsCfg_Hal_Context_myTask_1000ms,
    /* .Context               = */ &OsCfg_Hal_Context_myTask_1000ms_Dyn,
    /* .Stack                 = */ &OsCfg_Stack_OsCore0_Task_Prio22,
    /* .Dyn                   = */ OS_TASK_CASTDYN_TASK_2_THREAD(OsCfg_Task_myTask_1000ms_Dyn),
    /* .OwnerApplication      = */ &OsCfg_App_SystemApplication_OsCore0,
    /* .Core                  = */ &OsCfg_Core_OsCore0,
    /* .IntApiState           = */ &OsCfg_Core_OsCore0_Dyn.IntApiState,
    /* .TimeProtConfig        = */ NULL_PTR,
...
/*! Task configuration data: myTask_100ms */
CONST(Os_TaskConfigType, OS_CONST) OsCfg_Task_myTask_100ms =
{
  /* .Thread                = */
  {
    /* .ContextConfig         = */ &OsCfg_Hal_Context_myTask_100ms,
    /* .Context               = */ &OsCfg_Hal_Context_myTask_100ms_Dyn,
    /* .Stack                 = */ &OsCfg_Stack_OsCore0_Task_Prio21,
    /* .Dyn                   = */ OS_TASK_CASTDYN_TASK_2_THREAD(OsCfg_Task_myTask_100ms_Dyn),
    /* .OwnerApplication      = */ &OsCfg_App_SystemApplication_OsCore0,
    /* .Core                  = */ &OsCfg_Core_OsCore0,
    /* .IntApiState           = */ &OsCfg_Core_OsCore0_Dyn.IntApiState,
    /* .TimeProtConfig        = */ NULL_PTR,
...
/*! Task configuration data: myTask_20ms */
CONST(Os_TaskConfigType, OS_CONST) OsCfg_Task_myTask_20ms =
{
  /* .Thread                = */
  {
    /* .ContextConfig         = */ &OsCfg_Hal_Context_myTask_20ms,
    /* .Context               = */ &OsCfg_Hal_Context_myTask_20ms_Dyn,
    /* .Stack                 = */ &OsCfg_Stack_myTask_20ms,
    /* .Dyn                   = */ OS_TASK_CASTDYN_TASK_2_THREAD(OsCfg_Task_myTask_20ms_Dyn),
    /* .OwnerApplication      = */ &OsCfg_App_SystemApplication_OsCore0,
    /* .Core                  = */ &OsCfg_Core_OsCore0,
    /* .IntApiState           = */ &OsCfg_Core_OsCore0_Dyn.IntApiState,
    /* .TimeProtConfig        = */ NULL_PTR,
...
CONSTP2CONST(Os_TaskConfigType, OS_CONST, OS_CONST) OsCfg_TaskRefs[OS_TASKID_COUNT + 1] =
{
  ...
  OS_TASK_CASTCONFIG_TASK_2_TASK(OsCfg_Task_myTask_1000ms),
  OS_TASK_CASTCONFIG_TASK_2_TASK(OsCfg_Task_myTask_100ms),
  OS_TASK_CASTCONFIG_TASK_2_TASK(OsCfg_Task_myTask_20ms),
  NULL_PTR
};
