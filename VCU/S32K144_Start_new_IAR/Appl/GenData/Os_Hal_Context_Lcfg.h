...
extern VAR(Os_Hal_ContextType, OS_VAR_NOINIT) OsCfg_Hal_Context_myTask_1000ms_Dyn;


/*! HAL dynamic task context data: myTask_100ms */
extern VAR(Os_Hal_ContextType, OS_VAR_NOINIT) OsCfg_Hal_Context_myTask_100ms_Dyn;


/*! HAL dynamic task context data: myTask_20ms */
extern VAR(Os_Hal_ContextType, OS_VAR_NOINIT) OsCfg_Hal_Context_myTask_20ms_Dyn;
...
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_myTask_1000ms;

/*! HAL task context configuration data: myTask_100ms */
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_myTask_100ms;

/*! HAL task context configuration data: myTask_20ms */
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_myTask_20ms;
