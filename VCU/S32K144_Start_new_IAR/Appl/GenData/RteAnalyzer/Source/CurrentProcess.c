 ...
 *********************************************************************************************************************/
  ...
  *************************************************/
  ...
  fct_status = TSC_CurrentProcess_Rte_Read_DoorStatus_DoorStatus(&Read_DoorStatus_DoorStatus);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CurrentProcess_Rte_Read_rawCurrentData_rawCurrentData(&Read_rawCurrentData_rawCurrentData);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CurrentProcess_Rte_Write_current_data(Write_current_data);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CurrentProcess_Rte_Write_currentInvalid_data(Write_currentInvalid_data);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
