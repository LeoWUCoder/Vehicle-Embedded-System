...
# define Rte_Ev_Run_CurrentProcess2_Runnable_CurrentProcess2     ((EventMaskType)1ULL)
# define Rte_Ev_Run_CurrentProcess_Runnable_CurrentProcess     ((EventMaskType)2ULL)
