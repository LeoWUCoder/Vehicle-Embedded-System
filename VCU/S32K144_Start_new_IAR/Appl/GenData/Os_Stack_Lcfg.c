...
#define OS_START_SEC_STACK_OSCORE0_TASK_PRIO21_VAR_NOINIT_UNSPECIFIED
#include "Os_MemMap_Stacks.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */

/* Shared Task stack: OsCore0_Task_Prio21 */
/* User: [myTask_100ms] */
OS_STACK_DECLARE(OsCfg_Stack_OsCore0_Task_Prio21_Dyn, OS_CFG_SIZE_OSCORE0_TASK_PRIO21_STACK);

#define OS_STOP_SEC_STACK_OSCORE0_TASK_PRIO21_VAR_NOINIT_UNSPECIFIED
#include "Os_MemMap_Stacks.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
...
#define OS_START_SEC_STACK_MYTASK_20MS_VAR_NOINIT_UNSPECIFIED
#include "Os_MemMap_Stacks.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */

/* Shared Task stack: myTask_20ms */
/* User: [myTask_20ms] */
OS_STACK_DECLARE(OsCfg_Stack_myTask_20ms_Dyn, OS_CFG_SIZE_MYTASK_20MS_STACK);

#define OS_STOP_SEC_STACK_MYTASK_20MS_VAR_NOINIT_UNSPECIFIED
#include "Os_MemMap_Stacks.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
...
/*! Stack configuration data: OsCore0_Task_Prio21 */
CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_OsCore0_Task_Prio21 =
{
  /* .LowAddress  = */ OS_STACK_GETLOWADDRESS(OsCfg_Stack_OsCore0_Task_Prio21_Dyn),
  /* .HighAddress = */ OS_STACK_GETHIGHADDRESS(OsCfg_Stack_OsCore0_Task_Prio21_Dyn)
};
...
/*! Stack configuration data: myTask_20ms */
CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_myTask_20ms =
{
  /* .LowAddress  = */ OS_STACK_GETLOWADDRESS(OsCfg_Stack_myTask_20ms_Dyn),
  /* .HighAddress = */ OS_STACK_GETHIGHADDRESS(OsCfg_Stack_myTask_20ms_Dyn)
};
