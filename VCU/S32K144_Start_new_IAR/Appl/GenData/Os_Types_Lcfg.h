 ...
 *   Generation Time: 2026-01-30 13:25:13
...
#define myTask_1000ms myTask_1000ms
#define myTask_100ms myTask_100ms
#define myTask_20ms myTask_20ms
...
#define Rte_Al_TE_CurrentProcess_Runnable_CurrentProcess Rte_Al_TE_CurrentProcess_Runnable_CurrentProcess
...
typedef enum
{
  ...
  Rte_Al_TE_CurrentProcess_Runnable_CurrentProcess = 2,
  OS_ALARMID_COUNT = 3
} AlarmType;
