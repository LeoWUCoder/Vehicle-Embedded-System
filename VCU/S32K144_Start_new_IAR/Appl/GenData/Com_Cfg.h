 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: Com_Cfg.h
 *   Generation Time: 2025-10-25 10:46:51
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define ComConf_ComSignal_PowerMode_omsg_MyECU_Lamp_oCAN00_06cdc263_Tx 0u
#define ComConf_ComSignal_sig_LampCnt_02_omsg_MyECU_Lamp02_oCAN00_405a546e_Tx 1u
