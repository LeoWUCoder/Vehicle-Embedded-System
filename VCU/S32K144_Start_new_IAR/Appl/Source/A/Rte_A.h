 ...
 *       License:  CBD1800257
 *
 *   Description:  Application header file for SW-C <A> (Contract Phase)
 *********************************************************************************************************************/
...
extern CONSTP2CONST(struct Rte_CDS_A, RTE_CONST, RTE_CONST) Rte_Inst_A; /* PRQA S 0850 */ /* MD_MSR_19.8 */

# define RTE_STOP_SEC_CONST_UNSPECIFIED
# include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */

typedef P2CONST(struct Rte_CDS_A, TYPEDEF, RTE_CONST) Rte_Instance;
 ...
 * API prototypes
 *********************************************************************************************************************/
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_A_DoorStatus_data(P2VAR(uint8, AUTOMATIC, RTE_A_APPL_VAR) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_A_HeadLampStatus_data(P2VAR(uint8, AUTOMATIC, RTE_A_APPL_VAR) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_A_SteeringWheelAngle_Element(P2VAR(sint16, AUTOMATIC, RTE_A_APPL_VAR) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_A_WindowStatus_data(P2VAR(uint8, AUTOMATIC, RTE_A_APPL_VAR) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(Std_ReturnType, RTE_CODE) Rte_Write_A_A_data_Element1(uint16 data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(Std_ReturnType, RTE_CODE) Rte_Write_A_A_data_Element2(uint8 data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(Std_ReturnType, RTE_CODE) Rte_Write_A_WindowStatus_1_data(uint8 data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: RunnableA
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 ...
 *   Std_ReturnType Rte_Write_WindowStatus_1_data(uint8 data)
 *
 *********************************************************************************************************************/

# define RTE_RUNNABLE_RunnableA RunnableA
FUNC(void, A_CODE) RunnableA(void); /* PRQA S 0850 */ /* MD_MSR_19.8 */
