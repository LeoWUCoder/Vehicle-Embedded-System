 ...
 *   Generation Time: 2026-07-13 14:05:15
...
#define Rte_Al_TE_OsTask_APP_0_100ms Rte_Al_TE_OsTask_APP_0_100ms
...
typedef enum
{
  ...
  Rte_Al_TE_CpLedTask_LedRunnable = 3,
  Rte_Al_TE_OsTask_APP_0_100ms = 4,
  OS_ALARMID_COUNT = 5
} AlarmType;
